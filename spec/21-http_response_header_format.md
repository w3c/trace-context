...
Tracing systems MAY choose to include a `traceresponse` header on any response, regardless of whether or not a `traceparent` header was included on the request.
