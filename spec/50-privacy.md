...
The  `tracestate` field may contain any opaque value in any of the keys. The main purpose of this header is to provide additional vendor-specific information to correlate traces across different software components. 
